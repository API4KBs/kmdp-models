...
public class FHIR4JsonAdapter extends
    AbstractFHIRJsonAdapter<DomainResource, Resource, Parameters, Type> {

  private static final FhirContext fhirContext = FhirContext.forR4();
  protected static FHIR4JsonAdapter instance = new FHIR4JsonAdapter();

  private FHIR4JsonAdapter() {
    super(
        FHIR4JsonUtil.instance,
        Parameters.class,
        Parameters::new,
        FHIR4JsonAdapter::getParam,
        FHIR4JsonAdapter::setParam);
  }
  ...
  public static class FHIRSerializer extends JsonSerializer<Base> {
    ...
    public void serialize(Base v, JsonGenerator gen, SerializerProvider serializers)
      ...
      if (v == null) {
        ...
        gen.writeRawValue(FHIR4JsonUtil.instance.toJsonString((Resource) v));
        ...
        gen.writeRawValue(FHIR4JsonUtil.instance.toJsonString(b));
      } else {
        gen.writeObject(v);
      }
    }
