...
public class FHIR4QuestionnaireBuilder {

  private Questionnaire q;

  public static FHIR4QuestionnaireBuilder newQ(URI questionnaireId, String version, String qName,
      String qDescr, String code) {
    return new FHIR4QuestionnaireBuilder().newQuestionnaire(questionnaireId, version, qName, qDescr, code);
  }


  protected FHIR4QuestionnaireBuilder newQuestionnaire(URI qId, String version, String qName,
